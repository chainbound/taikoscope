...
ALTER TABLE ${DB}.l1_head_events
    ADD INDEX IF NOT EXISTS idx_l1_block_hash_bf block_hash TYPE bloom_filter(0.01) GRANULARITY 1;
...
ALTER TABLE ${DB}.l2_head_events
    ADD INDEX IF NOT EXISTS idx_l2_block_hash_bf block_hash TYPE bloom_filter(0.01) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_l2_sequencer_bf  sequencer  TYPE bloom_filter(0.01) GRANULARITY 1;
...
ALTER TABLE ${DB}.batches
    ADD INDEX IF NOT EXISTS idx_batches_batch_id_bf  batch_id   TYPE bloom_filter(0.01) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_batches_l1_tx_bf     l1_tx_hash TYPE bloom_filter(0.01) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_batches_proposer_bf  proposer_addr TYPE bloom_filter(0.01) GRANULARITY 1;
...
ALTER TABLE ${DB}.batch_blocks
    ADD INDEX IF NOT EXISTS idx_batch_blocks_l2_block_bf l2_block_number TYPE bloom_filter(0.01) GRANULARITY 1;
...
ALTER TABLE ${DB}.proved_batches
    ADD INDEX IF NOT EXISTS idx_proved_batches_batch_id_bf batch_id   TYPE bloom_filter(0.01) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_proved_batches_block_bf    block_hash TYPE bloom_filter(0.01) GRANULARITY 1;
...
ALTER TABLE ${DB}.verified_batches
    ADD INDEX IF NOT EXISTS idx_verified_batches_batch_id_bf batch_id   TYPE bloom_filter(0.01) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_verified_batches_block_bf    block_hash TYPE bloom_filter(0.01) GRANULARITY 1;
...
ALTER TABLE ${DB}.slashing_events
    ADD INDEX IF NOT EXISTS idx_slashing_validator_bf validator_addr TYPE bloom_filter(0.01) GRANULARITY 1;
...
ALTER TABLE ${DB}.l1_data_costs
    ADD INDEX IF NOT EXISTS idx_l1_data_costs_batch_id_bf batch_id TYPE bloom_filter(0.01) GRANULARITY 1;
...
ALTER TABLE ${DB}.prove_costs
    ADD INDEX IF NOT EXISTS idx_prove_costs_batch_id_bf batch_id TYPE bloom_filter(0.01) GRANULARITY 1;
ALTER TABLE ${DB}.prove_costs MATERIALIZE INDEX idx_prove_costs_batch_id_bf;

ALTER TABLE ${DB}.verify_costs
    ADD INDEX IF NOT EXISTS idx_verify_costs_batch_id_bf batch_id TYPE bloom_filter(0.01) GRANULARITY 1;
...
ALTER TABLE ${DB}.preconf_data
    ...
    ADD INDEX IF NOT EXISTS idx_preconf_next_op_bf    next_operator    TYPE bloom_filter(0.01) GRANULARITY 1;
...
ALTER TABLE ${DB}.l2_reorgs
    ADD INDEX IF NOT EXISTS idx_l2_reorgs_block_num_bf l2_block_number TYPE bloom_filter(0.01) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_l2_reorgs_old_seq_bf   old_sequencer   TYPE bloom_filter(0.01) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_l2_reorgs_new_seq_bf   new_sequencer   TYPE bloom_filter(0.01) GRANULARITY 1;
...
ALTER TABLE ${DB}.forced_inclusion_processed
    ADD INDEX IF NOT EXISTS idx_forced_inclusion_blob_bf blob_hash TYPE bloom_filter(0.01) GRANULARITY 1;
