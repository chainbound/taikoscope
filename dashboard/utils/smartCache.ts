    ...
    getOverallStats: () => {
        ...
        return {
            ...
            combined: {
                ...
                totalEntries: dashboard.totalEntries + chart.totalEntries + table.totalEntries,
                hitRate: (dashboard.hits + chart.hits + table.hits) /
                    (dashboard.hits + chart.hits + table.hits + dashboard.misses + chart.misses + table.misses) || 0,
            },
        };
    },
};