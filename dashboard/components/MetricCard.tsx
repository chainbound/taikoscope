...
export const MetricCard: React.FC<MetricCardProps> = ({
  ...
  return (
    <div
      className={`bg-card text-card-fg p-4 rounded-lg border border-slate-300 dark:border-slate-700 transition-shadow duration-200 ${isAddress ? 'min-w-0 w-full col-span-2 sm:col-span-2 md:col-span-2 lg:col-span-2 xl:col-span-2 2xl:col-span-2' : ''} ${className ?? ''}`.trim()}
    >
