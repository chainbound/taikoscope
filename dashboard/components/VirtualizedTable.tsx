...
const VirtualizedTable: React.FC<VirtualizedTableProps> = ({
    ...
    const Row = ({ index, style }: { index: number; style: React.CSSProperties }) => {
        ...
        return (
            <div
                style={style}
                className={`flex items-center border-b border-gray-200 dark:border-gray-700 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 ${isEven ? 'bg-white dark:bg-gray-900' : 'bg-gray-50 dark:bg-gray-800'
                    }`}
                    ...
                    >
                        <div className="flex flex-col space-y-2">
                            ...
                            <div className="flex items-center space-x-1">
                                <span
                                    className={`text-sm font-medium text-gray-900 dark:text-gray-100 ${column.sortable ? 'cursor-pointer hover:text-blue-600 dark:hover:text-blue-400' : ''
                                        }`}
