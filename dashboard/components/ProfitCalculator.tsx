...
export const ProfitCalculator: React.FC<ProfitCalculatorProps> = ({
  ...
  return (
    <div className="mt-6 p-4 border rounded-md bg-card text-card-fg border-gray-100 dark:border-0 dark:bg-[rgba(30,41,59,0.85)]">
      ...
      <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-2 sm:space-y-0">
        <label className="flex flex-col text-sm">
          ...
          <input
            type="number"
            min={0}
            className="p-1 border border-gray-100 dark:border-border rounded-md bg-card text-card-fg"
            value={cloudCost}
